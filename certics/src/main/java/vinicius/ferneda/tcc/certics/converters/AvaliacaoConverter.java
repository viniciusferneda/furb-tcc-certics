...
@FacesConverter(value= "ConversorAvaliacao")
public class AvaliacaoConverter implements Converter {

	private AvaliacaoDAO avaliacaoDAO = Beans.getReference(AvaliacaoDAO.class);
		...
		Object ret = null;
			if (component instanceof PickList) {
				...
				for (Object o : dl.getSource()) {
					String id = String.valueOf(((Avaliacao) o).getId());
					if (value.equals(id)) {
						ret = o;
						break;
					}

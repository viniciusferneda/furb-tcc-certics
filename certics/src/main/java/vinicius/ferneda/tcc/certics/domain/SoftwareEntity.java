...
public class SoftwareEntity extends Software {
	...
	public SoftwareEntity(String nome, String descricao, String historico, String tecnologias, String aspectoInovador, String release, Date dataInicio, Date dataLiberacaoVersao) {
		setNome(nome);

...
public class EvidenciaProfissionalListMB extends AbstractListPageBean<EvidenciaProfissionalEntity, Long> {
	...
	@Override
	protected List<EvidenciaProfissionalEntity> handleResultList() {

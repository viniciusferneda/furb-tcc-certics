...
@FacesConverter(value= "ConversorAnexo")
public class AnexoConverter implements Converter {

	private AnexoDAO anexoDAO = Beans.getReference(AnexoDAO.class);
		...
		Object ret = null;
			if (component instanceof PickList) {
				...
				for (Object o : dl.getSource()) {
					String id = String.valueOf(((Anexo) o).getId());
					if (value.equals(id)) {
						ret = o;
						break;
					}
	...
	public String getAsString(FacesContext context, UIComponent component,
		...
		try{
			if (value == null || value.equals("")) {
				...
				return String.valueOf(((Anexo) value).getId());
			}
		}catch (Exception e) {
			e.printStackTrace();
			return "";

...
public class ConjuntoEvidenciasListMB extends AbstractListPageBean<ConjuntoEvidenciasEntity, Long> {
	...
	@Override
	protected List<ConjuntoEvidenciasEntity> handleResultList() {

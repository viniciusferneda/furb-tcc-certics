...
@FacesConverter(value= "ConversorAvaliador")
public class AvaliadorConverter implements Converter {

	private AvaliadorDAO avaliadorDAO = Beans.getReference(AvaliadorDAO.class);
		...
		Object ret = null;
			if (component instanceof PickList) {
				...
				for (Object o : dl.getSource()) {
					String id = String.valueOf(((Avaliador) o).getId());
					if (value.equals(id)) {
						ret = o;
						break;
					}
	...
	public String getAsString(FacesContext context, UIComponent component,
		...
		try{
			if (value == null || value.equals("")) {
				...
				return String.valueOf(((Avaliador) value).getId());
			}
		}catch (Exception e) {
			e.printStackTrace();
			return "";
